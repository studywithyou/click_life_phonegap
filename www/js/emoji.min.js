...
emojiApp.config(["$sceProvider", function (a) {
    ...
    for (c = 0; c < Config.EmojiCategories.length; c++)for (h = Config.EmojiCategorySpritesheetDimens[c][1], b = 0; b < Config.EmojiCategories[c].length; b++)e = Config.Emoji[Config.EmojiCategories[c][b]], d = e[1][0], f = Math.floor(b / h), g = b % h, i[":" + d + ":"] = [c, f, g, ":" + d + ":"], j[d] = e[0];
    ...
    function e(b, e, f) {
        ...
        b.$on("$destroy", function () {
            $(document).off("paste", k), $(document).off("keydown", l), $("#emojibtn").off("mousedown"), n.off("change"), q && $(q).off("DOMNodeInserted keyup", j), $(p).off("keydown")
        })
    }
